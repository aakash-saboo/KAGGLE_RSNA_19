...
if __name__=='__main__':
    # model = res2net(depth=50, num_classes=6, width_per_group=26, scale=4, pretrained=False, progress=True).cuda()
    model = res2next(depth=50, num_classes=6, width_per_group=4, scale=4, pretrained=False, progress=True).cuda()
    print(model)

workdir = './model/SE_RESNEXT101'
seed = 20
apex = True

n_fold = 5
epoch = 15
# resume_from = './model/oct_resnet101/fold0_ep10.pt'
resume_from = None
new_lr_bool = False
new_lr = 6e-5
...
data = dict(
    train=dict(
        ...
        imgdir='/home/8tb/RSNA_CHALLENGE_FOLDER/stage_1_train_images',
        imgsize=imgsize,
        n_grad_acc=1,
        loader=dict(
            shuffle=True,
    ...
    test = dict(
        ...
        imgdir='/home/8tb/RSNA_CHALLENGE_FOLDER/stage_1_test_images',
        imgsize=imgsize,
        loader=dict(
            shuffle=False,
            batch_size=batch_size,
